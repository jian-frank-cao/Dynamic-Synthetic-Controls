...
# 
# ## Run -------------------------------------------------------------------------
# data.list = readRDS("./data/simul_data_arima111.Rds")
# 
# # parameters
...
# # )
# # saveRDS(results, paste0("./data/res_sim/arima111/res_sim_beta1_", i, ".Rds"))
# # cat("Done.\n")
# # 
# # job.end = Sys.time()
...
#                 grid.search.parallel = grid.search.parallel)
#   )
#   saveRDS(results, paste0("./data/res_sim/arima111/res_sim_", i, ".Rds"))
#   cat("Done.\n")
# }
# 
# job.end = Sys.time()
...
## Test result -----------------------------------------------------------------
folder = paste0("./data/res_sim/arima111/")
...
saveRDS(df.mse, paste0("./data/df.mse_sim_arima111.Rds"))
