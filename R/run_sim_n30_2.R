...
saveRDS(data.list, paste0("./data/simul_data_beta1_n30_2.Rds"))
...
## Run -------------------------------------------------------------------------
data.list = readRDS("./data/simul_data_beta1_n30_2.Rds")
...
for (i in 1:100) {
  ...
  saveRDS(results, paste0("./data/res_sim/n30_2/res_sim_n30_", i, ".Rds"))
  cat("Done.\n")
}
